...
function renderCourses(searchQuery = "", category = "", amount = "") {
  console.log(amount);
    ...
    <div class="card" >
      ...
      <div class="card-content">
        ...
        <div class="buttons">
          ...
          <button class="btn btn-viewdetails">
  <a href='Details-Page.html?id=${course.id}&data=${encodeURIComponent(
...
function Discount(id) {
  ...
  for (let i = 0; i < Courses.length; i++) {
    if (Courses[i].id == id) {
      ...
      let am = priceNum - discountedPrice;

      Courses[i].discountAmount = am.toFixed(3);
